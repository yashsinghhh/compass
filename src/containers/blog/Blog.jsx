...
<div class="card_blog">
  <div class="item item--1">
    ...
    <span class="text text--1"> Interactions </span>
  </div>
  <div class="item item--2">
    ...
    <span class="text text--2"> Online Sessions </span>
  </div>
  <div class="item item--3">
    ...
    <span class="text text--3"> Students </span>
  </div>
  <div class="item item--4">
    ...
    <span class="text text--4"> Scheduled meetups </span>
  </div>
</div>  )
}
